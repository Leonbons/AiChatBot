...
words = [lemmatizer.lemmetizer(word) for word in words not in ignore_letters]
...
for document in documents:
    ...
    word_patterns = [lemmatizer.lemmetize(word.lower()) for word in word_patterns]
    for word in words:
...
model.compile(loss='categorical_crossentropy', omptimizer=sgd, matrics=['accuracy'])
